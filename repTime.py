...
bcsScriptName = "200FF0p05d_fitted_s10" # 10 simulations of a fitted model with F=200 and recycling rates of 0.05 (It is recommended to generate and analyse a 500 simulation output)
