...
parameter_df = ori_df[['i','ch','length','fire']]
...
import os
if not os.path.exists('bcs_scripts'):
    os.makedirs('bcs_scripts')
file_path = f"bcs_scripts/200FF0p05d.bc" # example file (as shown in other scripts)
# custom name:
